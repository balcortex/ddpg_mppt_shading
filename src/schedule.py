...
class Schedule(ABC):
    """
    The Schedule is used to provide a float value that can be constant or
    decay over time
    """
    ...
    def set_current_step(self, step: int) -> float:
        """Set the step to counter and return the current value of epsilon"""

    @abstractclassmethod
    def reset(self) -> float:
        """Reset the step counter to zero and return the current value of epsilon"""
